...
export default function Navbar({ click, publicBoards, privateBoards, couple_id }) {
  ...
  return (
    <div className="bg-hibye-10 p-4 text-hibye-60 absolute z-50 -translate-x-4 block max-w-xs">
      ...
      {couple_id ? <PrivateBoards boards={privateBoards} click={click} choseIcon={choseIcon} /> : null}
    </div>
  );
}
