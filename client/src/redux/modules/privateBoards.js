...
export const getPrivateBoards = createAsyncThunk("boards/privateBoards", async (coupleId) => {
  const response = await axios.get(`${process.env.REACT_APP_API_URL}/board/${coupleId}`);
